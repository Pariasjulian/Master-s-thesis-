...
\begin{figure}[ht]
    ...
    \end{tikzpicture}
    \caption{Visual representation of the MONEEE serial data transmission frame. The initial three bytes ($B_0, B_1, B_2$) form a dedicated hardware synchronization prefix attached to every physiological sample, ensuring that event timing is locked to the data stream before USB transmission.}
