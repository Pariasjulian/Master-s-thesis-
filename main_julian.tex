...
\include{Julian/agradecimientos}   
...
\include{Cap 1/Outline_and_contributions}
\include{Cap 1/preliminaries}
\include{Cap 1/problem_statement}
\include{Cap 1/objetivos}
\include{Cap 1/state_of_art}
\include{Cap 2/Arquitectura}
\include{Cap 3/System_Architecture}
\include{Cap 4/Hardware_Design}
\include{Cap 5/Digital_control_and_data_transmission}
\include{Cap 6/Syncronization_module}
\include{Cap 7/PCB_Design}
\include{Cap 8/Power_management}
\include{Cap 9/Validation}    

%\include{Julian/Appendix}

%Inicio del apéndice o anexos
% \begin{appendix}
% \include{santiago/Appendix}%
% \end{appendix}
