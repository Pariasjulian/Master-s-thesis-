...
\include{santiago/Agradecimientos}   
\include{santiago/abbreviations}
\begingroup
%\pagenumbering{roman}
%\printglossary[type=\acronymtype, title=Abbreviations]
%\glsresetall
...
\include{santiago/Preliminaries}
\include{santiago/problem_statement_v3}
\include{santiago/State_of_art_v2}
\include{santiago/Objectives}
\include{santiago/Outline_and_contributions}
%\include{santiago/Materials_and_methods}

\include{santiago/Objective_1}
\include{santiago/Objective_1}


\include{santiago/Final_remarks}
...
\bibliography{santiago/References}
\nocite{*}
\cleardoublepage
}
