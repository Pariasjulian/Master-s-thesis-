...
Based on the identified challenges, the main research question is: How can an EEG-based data acquisition framework be engineered to mitigate mixed-signal interference and strictly bound communication latency, thereby ensuring the precise temporal synchronization required for reliable neurocognitive assessments in ADHD monitoring?
