...
\subsection{SNR limitations in embedded systems and their impact on portable EEG}
...
\subsection{Synchronization and temporal variability in \gls{EEG} biomarkers for ADHD}
