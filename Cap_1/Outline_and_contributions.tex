...
Bearing this in mind, we propose a novel, rapidly deployable \gls{EEG} cap design and a systematic electrode-skin impedance measurement protocol. This development overcomes physical barriers and maximizes the initial signal-to-noise ratio (\gls{SNR}), ensuring high-fidelity analog input for the subsequent acquisition stages. The practical design and validation of this optimized interface are detailed in Chapter \ref{ch:hardware_architecture}.
